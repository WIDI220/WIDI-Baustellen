                ...
                {[...pages]
                  ...
                  <div key={p.page} className={`rounded-xl px-3 py-2.5 border text-xs transition-all
                    ${p.imported ? 'bg-emerald-50 border-emerald-200' :
                      ...
                      p.status === 'duplicate' ? 'bg-gray-50 border-gray-200' :
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {p.status === 'duplicate' && <span className="text-gray-400 text-base">🔁</span>}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {p.status === 'duplicate' && <span className="text-gray-400">Duplikat</span>}
                      </div>
                    </div>
                  </div>
                ))}
